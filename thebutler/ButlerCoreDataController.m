...
@interface ButlerCoreDataController ()
...
@implementation ButlerCoreDataController
...
+ (id)sharedInstance {
    ...
    static ButlerCoreDataController *sharedInstance;
    dispatch_once(&once, ^{
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Butler" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"thebutler.sqlite"];
